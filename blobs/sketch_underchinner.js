...
function Bblob(which_Degas, color, t_color, t_t_color, x_el, y_el, x_el_t, y_el_t, fir_att, sec_att, x_cord, l_or_r) {
  ...
  this.updateBlobs = function(){
    ...
    if(l_or_r == "left"){
      this.x_changed = [this.x_1-10, this.x_2-15+21, this.x_2-15-18, this.x_3+5];
      this.y_changed = [this.y_1, this.y_2-3, this.y_2+38, this.y_3];
      this.x_changed_t = [this.x_2+10, this.x_2-10, this.x_2-20];
      this.y_changed_t = [this.y_2-1, this.y_2-5, this.y_2+19];
