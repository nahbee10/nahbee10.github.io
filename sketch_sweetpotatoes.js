...
function setup() {
  ...
  var vec_att = new Vec2D(((x_el[0]/10+x_el[x_el.length-1]*9/10)*magnif),(y_el[0]/10+y_el[y_el.length-1]*9/10)*magnif+40);
  var vec_att2 = new Vec2D(((x_el[0]*9/10+x_el[x_el.length-1]/10)*magnif),(y_el[0]*9/10+y_el[y_el.length-1]/10)*magnif+40);
  ...
  first_class_blob2 = new Bblob(d,colors_b[c_index], colors_b_t_t[c_index], colors_b_t[c_index], x_el, y_el, x_el_t, y_el_t, vec_att_next, vec_att2_next, dista, "right");
...
function Bblob(which_Degas, color, t_color, t_t_color, x_el, y_el, x_el_t, y_el_t, fir_att, sec_att, x_cord, l_or_r) {
  ...
  this.updateBlobs = function(){
    ...
    this.x_changed = [this.x_1, this.x_2, this.x_2, this.x_3];
    this.y_changed = [this.y_1, this.y_2, this.y_2+25, this.y_3];
    this.x_changed_t = [this.x_2+25, this.x_2-10, this.x_2+5];
    this.y_changed_t = [this.y_2-4, this.y_2-5, this.y_2+35];
