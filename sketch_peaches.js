...
function Bblob(which_Degas, color, t_color, t_t_color, x_el, y_el, x_el_t, y_el_t, fir_att, sec_att, x_cord, l_or_r) {
  ...
  this.updateBlobs = function(){
    ...
    if(l_or_r == "left"){
      this.x_changed = [this.x_1, (this.x_1 + this.x_2)/2 - 10, this.x_2];
      this.y_changed = [this.y_1, (this.y_1 + this.y_2)/2 + 20, this.y_2];
      this.x_changed_t = [this.x_1+15, (this.x_1 + this.x_2)/2 - 25, this.x_2-25];
      this.y_changed_t = [this.y_1+35, (this.y_1 + this.y_2)/2 + 40, this.y_2];
